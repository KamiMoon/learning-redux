    ...
    return (
        <div>
            <article itemScope itemType="http://schema.org/NewsArticle">
                <meta itemScope itemProp="mainEntityOfPage" itemType="https://schema.org/WebPage" itemID={seo.url} />
                <Link to={`blog/${post._id}`} itemProp="headline" rel="bookmark" className="post-title" title={post.title}>{post.title}</Link>
                <hr />
                <ul className="blog-meta-list">
                    {post.user_name &&
                        <li itemProp="author" itemScope itemType="https://schema.org/Person">
                        <span className="glyphicon glyphicon-user" aria-hidden="true"></span> By <span itemProp="name">{post.user_name}</span>
                    </li>
                    }
                    ...
                    <li id="datePublished" className="date">
                        ...
                        <span className="glyphicon glyphicon-time" aria-hidden="true"></span> {post.createdAt}
                    </li>
                    <li className="comments" property="discussionUrl">
                        <a href="/blog/{post._id}" className="btn btn-primary" type="button">
                        Comments  <span className="badge disqus-comment-count" data-disqus-url="http://www.erickizaki.com/blog/{post._id}"></span>
                        </a>
                    </li>
                ...
                <div itemProp="publisher" itemScope itemType="https://schema.org/Organization">
                    <div itemProp="logo" itemScope itemType="https://schema.org/ImageObject">
                        <meta itemProp="url" content="https://www.preservedfw.com/assets/Preserve_US_nav_bar.png" />
